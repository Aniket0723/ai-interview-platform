    ...
    <ScreenShell>
        <section className="grid flex-1 items-center gap-8 py-8 lg:grid-cols-[1.05fr_0.95fr] lg:py-10">
          ...
          >
            ...
            <div className="mt-7 grid auto-rows-fr gap-2.5 sm:grid-cols-2">
              {candidateInstructions.map((instruction) => (
                <div
                  key={instruction}
                  className="flex min-h-16 gap-2.5 rounded-lg border border-slate-200 bg-white p-2.5 shadow-sm"
                >
                  <CheckCircle2
